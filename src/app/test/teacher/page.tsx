...
export default function StudentTest() {
  ...
  const submitAdd = async () => {
    ...
    const response = await axios.post('/api/teacher/add', data).catch(
      (e) => {
  ...
  const submitDelete = async () => {
    ...
    const response = await axios.post('/api/teacher/delete', data).catch(
      (e) => {
        const str = JSON.stringify(e.response.data)
        alert(str)
        setRes(str)
  ...
  const submitCheck = async () => {
    const data = {name: name, pass: pass}
    const response = await axios.post('/api/teacher/auth', data).catch(
      (e) => {
        const str = JSON.stringify(e.response.data)
        alert(str)
        setRes(str)
  ...
  const submitChangePass = async () => {
    ...
    const response = await axios.post('/api/teacher/change-pass', data).catch(
      (e) => {
        const str = JSON.stringify(e.response.data)
        alert(str)
        setRes(str)
